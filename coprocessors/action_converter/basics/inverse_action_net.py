...
class InverseActionNet(nn.Module):
    ...
    def __init__(
        ...
        super(InverseActionNet, self).__init__()
        ...
        self.layers = nn.Sequential(
            nn.Linear(obs_size + act_size + additional_input, hid_size1),
            nn.ReLU(),
            nn.Linear(hid_size1, hid_size2),
            nn.ReLU(),
            nn.Linear(hid_size2, hid_size3),
            nn.ReLU(),
            nn.Linear(hid_size3, stim_size),
            nn.Tanh()
        )
