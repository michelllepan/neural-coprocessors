...
myosuite_myobase_suite = set(gym.envs.registration.registry.keys())-myosuite_env_suite-_current_gym_envs
...
myosuite_myochal_suite = set(gym.envs.registration.registry.keys())-myosuite_env_suite-_current_gym_envs
...
myosuite_myodex_suite = set(gym.envs.registration.registry.keys())-myosuite_env_suite-_current_gym_envs
