...
class CarEnv(gym.Env):
    ...
    def __init__(self, args=None, max_actions=1200, rendering=False):
        ...
        self.num_timesteps_remaining = None
    ...
    def step(self, action):
        ...
        self.num_timesteps_remaining -= 1
        ...
        min_position = min(self.heaven_position, self.hell_position)
            ...
            position >= max_position or position <= min_position or self.num_timesteps_remaining == 0
        )
    ...
    def reset(self):
        ...
        self.num_timesteps_remaining = 160
